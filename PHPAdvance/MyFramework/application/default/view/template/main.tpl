...
<head>
	...
	<link rel="shortcut icon" href="{$resourceUrl}/images/default/favicon.ico" />
	<link rel="stylesheet" href="{$resourceUrl}/css/default/style.css" type="text/css" media="all" />
	<script type="text/javascript" src="{$resourceUrl}/js/default/jquery-1.6.2.min.js"></script>
	<script type="text/javascript" src="{$resourceUrl}/js/default/jquery.jcarousel.min.js"></script>
	<!--[if IE 6]>
		<script type="text/javascript" src="js/png-fix.js"></script>
	<![endif]-->
	<script type="text/javascript" src="{$resourceUrl}/js/default/functions.js"></script>
</head>
<body>
	<!-- Header -->
	<div id="header" class="shell">
		...
		<div id="login-details">
			<p>Welcome, <a href="{$baseUrl}/admin" id="user">Login</a> .</p><p><a href="#" class="cart" ><img 
			src="{$resourceUrl}/images/default/cart-icon.png" alt="" /></a>Shopping Cart (0) <a href="#" class="sum">$0.00</a></p>
		</div>
		<!-- End Login-details -->
	</div>
	<!-- End Header -->
	...
	<div id="slider">
		<div class="shell">
			<ul>
				<li>
					<div class="image">
						<img src="{$resourceUrl}/images/default/books.png" alt="" />
					</div>
					<div class="details">
						<h2>Bestsellers</h2>
				...
				<ul>
					<li>
						<div class="product">
							<a href="#" class="info">
								<span class="holder">
									<img src="{$resourceUrl}/images/default/image01.jpg" alt="" />
					...
					<li>
						<div class="product">
							<a href="#" class="info">
								<span class="holder">
									<img src="{$resourceUrl}/images/default/image02.jpg" alt="" />
									<span class="book-name">Book Name</span>
									<span class="author">by John Smith</span>
									<span class="description">Maecenas vehicula ante eu enim pharetra<br />scelerisque dignissim <br />sollicitudin nisi</span>
								</span>
					...
					<li>
						<div class="product">
							<a href="#" class="info">
								<span class="holder">
									<img src="{$resourceUrl}/images/default/image03.jpg" alt="" />
									<span class="book-name">Book Name</span>
									<span class="author">by John Smith</span>
									<span class="description">Maecenas vehicula ante eu enim pharetra<br />scelerisque dignissim <br />sollicitudin nisi</span>
								</span>
					...
					<li>
						<div class="product">
							<a href="#" class="info">
								<span class="holder">
									<img src="{$resourceUrl}/images/default/image04.jpg" alt="" />
									<span class="book-name">Book Name</span>
									<span class="author">by John Smith</span>
									<span class="description">Maecenas vehicula ante eu enim pharetra<br />scelerisque dignissim <br />sollicitudin nisi</span>
								</span>
					...
					<li>
						<div class="product">
							<a href="#" class="info">
								<span class="holder">
									<img src="{$resourceUrl}/images/default/image05.jpg" alt="" />
									<span class="book-name">Book Name</span>
									<span class="author">by John Smith</span>
									<span class="description">Maecenas vehicula ante eu enim pharetra<br />scelerisque dignissim <br />sollicitudin nisi</span>
								</span>
					...
					<li>
						<div class="product">
							<a href="#" class="info">
								<span class="holder">
									<img src="{$resourceUrl}/images/default/image06.jpg" alt="" />
									<span class="book-name">Book Name</span>
									<span class="author">by John Smith</span>
									<span class="description">Maecenas vehicula ante eu enim pharetra<br />scelerisque dignissim <br />sollicitudin nisi</span>
								</span>
					...
					<li>
						<div class="product">
							<a href="#" class="info">
								<span class="holder">
									<img src="{$resourceUrl}/images/default/image07.jpg" alt="" />
									<span class="book-name">Book Name</span>
									<span class="author">by John Smith</span>
									<span class="description">Maecenas vehicula ante eu enim pharetra<br />scelerisque dignissim <br />sollicitudin nisi</span>
								</span>
					...
					<li>
						<div class="product">
							<a href="#" class="info">
								<span class="holder">
									<img src="{$resourceUrl}/images/default/image08.jpg" alt="" />
									<span class="book-name">Book Name</span>
									<span class="author">by John Smith</span>
									<span class="description">Maecenas vehicula ante eu enim pharetra<br />scelerisque dignissim <br />sollicitudin nisi</span>
								</span>
			...
			<div id="best-sellers">
				...
				<ul>
					<li>
						<div class="product">
							<a href="#">
								<img src="{$resourceUrl}/images/default/image-best01.jpg" alt="" />
								<span class="book-name">Book Name </span>
								<span class="author">by John Smith</span>
					...
					<li>
						<div class="product">
							<a href="#">
								<img src="{$resourceUrl}/images/default/image-best02.jpg" alt="" />
								<span class="book-name">Book Name </span>
								<span class="author">by John Smith</span>
					...
					<li>
						<div class="product">
							<a href="#">
								<img src="{$resourceUrl}/images/default/image-best03.jpg" alt="" />
								<span class="book-name">Book Name </span>
								<span class="author">by John Smith</span>
					...
					<li>
						<div class="product">
							<a href="#">
								<img src="{$resourceUrl}/images/default/image-best04.jpg" alt="" />
								<span class="book-name">Book Name </span>
								<span class="author">by John Smith</span>

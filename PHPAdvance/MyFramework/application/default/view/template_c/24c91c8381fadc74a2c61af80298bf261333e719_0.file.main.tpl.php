...
<head>
	...
	<link rel="shortcut icon" href="<?php echo $_smarty_tpl->tpl_vars['resourceUrl']->value;?>
/images/default/favicon.ico" />
	<link rel="stylesheet" href="<?php echo $_smarty_tpl->tpl_vars['resourceUrl']->value;?>
/css/default/style.css" type="text/css" media="all" />
	<?php echo '<script'; ?>
 type="text/javascript" src="<?php echo $_smarty_tpl->tpl_vars['resourceUrl']->value;?>
/js/default/jquery-1.6.2.min.js"><?php echo '</script'; ?>
>
	<?php echo '<script'; ?>
 type="text/javascript" src="<?php echo $_smarty_tpl->tpl_vars['resourceUrl']->value;?>
/js/default/jquery.jcarousel.min.js"><?php echo '</script'; ?>
>
	<!--[if IE 6]>
		<?php echo '<script'; ?>
 type="text/javascript" src="js/png-fix.js"><?php echo '</script'; ?>
>
	<![endif]-->
	<?php echo '<script'; ?>
 type="text/javascript" src="<?php echo $_smarty_tpl->tpl_vars['resourceUrl']->value;?>
/js/default/functions.js"><?php echo '</script'; ?>
>
</head>
<body>
	<!-- Header -->
	...
	<div id="slider">
		<div class="shell">
			<ul>
				<li>
					<div class="image">
						<img src="<?php echo $_smarty_tpl->tpl_vars['resourceUrl']->value;?>
/images/default/books.png" alt="" />
					</div>
					<div class="details">
						<h2>Bestsellers</h2>
					...
					<li>
						<div class="product">
							<a href="#" class="info">
								<span class="holder">
									<img src="<?php echo $_smarty_tpl->tpl_vars['resourceUrl']->value;?>
/images/default/image01.jpg" alt="" />
					...
					<li>
						<div class="product">
							<a href="#" class="info">
								<span class="holder">
									<img src="<?php echo $_smarty_tpl->tpl_vars['resourceUrl']->value;?>
/images/default/image02.jpg" alt="" />
									<span class="book-name">Book Name</span>
									<span class="author">by John Smith</span>
									<span class="description">Maecenas vehicula ante eu enim pharetra<br />scelerisque dignissim <br />sollicitudin nisi</span>
								</span>
					...
					<li>
						<div class="product">
							<a href="#" class="info">
								<span class="holder">
									<img src="<?php echo $_smarty_tpl->tpl_vars['resourceUrl']->value;?>
/images/default/image03.jpg" alt="" />
									<span class="book-name">Book Name</span>
									<span class="author">by John Smith</span>
									<span class="description">Maecenas vehicula ante eu enim pharetra<br />scelerisque dignissim <br />sollicitudin nisi</span>
								</span>
					...
					<li>
						<div class="product">
							<a href="#" class="info">
								<span class="holder">
									<img src="<?php echo $_smarty_tpl->tpl_vars['resourceUrl']->value;?>
/images/default/image04.jpg" alt="" />
									<span class="book-name">Book Name</span>
									<span class="author">by John Smith</span>
									<span class="description">Maecenas vehicula ante eu enim pharetra<br />scelerisque dignissim <br />sollicitudin nisi</span>
								</span>
					...
					<li>
						<div class="product">
							<a href="#" class="info">
								<span class="holder">
									<img src="<?php echo $_smarty_tpl->tpl_vars['resourceUrl']->value;?>
/images/default/image05.jpg" alt="" />
									<span class="book-name">Book Name</span>
									<span class="author">by John Smith</span>
									<span class="description">Maecenas vehicula ante eu enim pharetra<br />scelerisque dignissim <br />sollicitudin nisi</span>
								</span>
					...
					<li>
						<div class="product">
							<a href="#" class="info">
								<span class="holder">
									<img src="<?php echo $_smarty_tpl->tpl_vars['resourceUrl']->value;?>
/images/default/image06.jpg" alt="" />
									<span class="book-name">Book Name</span>
									<span class="author">by John Smith</span>
									<span class="description">Maecenas vehicula ante eu enim pharetra<br />scelerisque dignissim <br />sollicitudin nisi</span>
								</span>
					...
					<li>
						<div class="product">
							<a href="#" class="info">
								<span class="holder">
									<img src="<?php echo $_smarty_tpl->tpl_vars['resourceUrl']->value;?>
/images/default/image07.jpg" alt="" />
									<span class="book-name">Book Name</span>
									<span class="author">by John Smith</span>
									<span class="description">Maecenas vehicula ante eu enim pharetra<br />scelerisque dignissim <br />sollicitudin nisi</span>
								</span>
					...
					<li>
						<div class="product">
							<a href="#" class="info">
								<span class="holder">
									<img src="<?php echo $_smarty_tpl->tpl_vars['resourceUrl']->value;?>
/images/default/image08.jpg" alt="" />
									<span class="book-name">Book Name</span>
									<span class="author">by John Smith</span>
									<span class="description">Maecenas vehicula ante eu enim pharetra<br />scelerisque dignissim <br />sollicitudin nisi</span>
								</span>
				...
				<ul>
					<li>
						<div class="product">
							<a href="#">
								<img src="<?php echo $_smarty_tpl->tpl_vars['resourceUrl']->value;?>
/images/default/image-best01.jpg" alt="" />
								<span class="book-name">Book Name </span>
								<span class="author">by John Smith</span>
					...
					<li>
						<div class="product">
							<a href="#">
								<img src="<?php echo $_smarty_tpl->tpl_vars['resourceUrl']->value;?>
/images/default/image-best02.jpg" alt="" />
								<span class="book-name">Book Name </span>
								<span class="author">by John Smith</span>
					...
					<li>
						<div class="product">
							<a href="#">
								<img src="<?php echo $_smarty_tpl->tpl_vars['resourceUrl']->value;?>
/images/default/image-best03.jpg" alt="" />
								<span class="book-name">Book Name </span>
								<span class="author">by John Smith</span>
					...
					<li>
						<div class="product">
							<a href="#">
								<img src="<?php echo $_smarty_tpl->tpl_vars['resourceUrl']->value;?>
/images/default/image-best04.jpg" alt="" />
								<span class="book-name">Book Name </span>
								<span class="author">by John Smith</span>

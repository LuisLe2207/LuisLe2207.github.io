...
<body>
				...
				<ul class="nav navbar-nav navbar-mobile">
					...
					<li>
						<button type="button" class="navbar-toggle">
							<img class="profile-img" src="{$resourceUrl}/css/admin/assets/images/profile.png">
						</button>
					</li>
				</ul>
	...
	<script type="text/javascript" src="{$resourceUrl}/css/admin/assets/js/vendor.js"></script>
	<script type="text/javascript" src="{$resourceUrl}/css/admin/assets/js/app.js"></script>
	<script type="text/javascript" src="{$resourceUrl}/js/admin/index/index.js"></script>
